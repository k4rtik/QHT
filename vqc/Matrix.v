...
(* HIDE: Include something about lightweight dependent types? *)
...
(** FULL: What went wrong? While we can rewrite using [==], we don't
...
(** TERSE: We haven't shown that [+] respects [==]!
...
Add Parametric Morphism m n c : (@Mscale m n c)
  with signature mat_equiv ==> mat_equiv as Mscale_mor.

?

These seem to be equivalent, not sure which is better. *)
